...
Welcome to the course **Musikinformatik** of the `Robert Schumann Hochschule Düsseldorf <https://www.rsh-duesseldorf.de/>`_ for SoSe 2021.
...
Within the course we will rely on the programming language `Python <https://www.python.org/>`_  - a high level scripting language -
which became a per-se standard for data analytics and machine learning over the last years.

We will also rely on the sound platform `SuperCollider <https://supercollider.github.io/>`_ for
generating sounds.
